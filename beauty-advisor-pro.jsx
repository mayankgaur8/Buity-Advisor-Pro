...
import logo from "./assets/avantika-logo.png";
...
// ─── Main App ─────────────────────────────────────────────────────────────────
export default function BeautyAdvisorPro() {
    ...
    <div style={s.root}>
      ...
      {screen === "landing" && (
        <div style={s.page} className="fadeUp">
          <div style={s.logoRow}><img src={logo} alt="Avantika Logo" style={{ height: "44px", objectFit: "contain" }} /></div>
          <h1 style={s.hero}>
        ...
        <div style={s.resultsPage}>
          ...
          <div style={s.resultsHero}>
            ...
            <div style={s.resultsIntro}>
              <div style={s.miniLogo}>✦ LUMINA AI</div>
